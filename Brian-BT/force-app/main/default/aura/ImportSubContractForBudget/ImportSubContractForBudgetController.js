({
    doInit : function(component, event, helper) {
        ...
        action.setCallback(this, function(response){
            ...
            if(state === "SUCCESS"){
                ...
                console.log("Labels : "+JSON.stringify(result));
                ...
                console.log("records to iterate : "+JSON.stringify(PaginationList));
                component.set('v.PaginationList', PaginationList);
                console.log("Records : ",JSON.stringify( component.get('v.PaginationList')));
    ...
    importBudget : function(component, event, helper){
        ...
        if(budgetIds.length > 0){
            ...
            var action = component.get("c.importSubContractItems");  
            action.setParams({
                budgetIds : budgetIds,
            ...
            toastEvent.setParams({
                "title": "Error!",
                "message": 'Please Select at least One Sub-Contract record.',
                "type": 'Error',
                "duration": '10000',
                "mode": 'dismissible'
            });    
            ...
            if(searchKey != ''){
                ...
                action1.setCallback(this, function(response){
                    ...
                    if(state === "SUCCESS"){
                        ...
                        component.set('v.newRecordList', PaginationList);
                        component.set("v.Spinner", false);
                    }
                });
