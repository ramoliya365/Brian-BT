            ...
            if (response.getState() == 'SUCCESS') {
                ...
                action1.setCallback(this, function (response1) {
                    if (response1.getState() == 'SUCCESS') {
                        ...
                        if(result.recordtype.name == 'Vendor' && result.buildertek__Status__c != 'Company Approved'){
                            ...
                            toastEvent.fire(); 
                        }else if(recordtype.name == 'Standard' && result.buildertek__Status__c != 'Pending'){
                            $A.get("e.force:closeQuickAction").fire();
                            var toastEvent = $A.get("e.force:showToast");
                            toastEvent.setParams({
                                title : "Error!",
                                message : 'You can Manage Standard SOV only when the Status is Pending',
                                type: 'error',
                                duration: '1000',
                                key: 'info_alt',
                                mode: 'pester'
                                    ...
                                    workspaceAPI.openSubtab({
                                        ...
                                        pageReference: {
                                            ...
                                            "attributes": {
                                                "recordId" : recordId,
                                                "ManageSovId" :sovId,
                                                "componentName": "buildertek__ManageSOVClone"
                                            },
                                            "state": {
                                                "buildertek__parentId": recordId,
                                                "buildertek__ManageSovId" : sovId
