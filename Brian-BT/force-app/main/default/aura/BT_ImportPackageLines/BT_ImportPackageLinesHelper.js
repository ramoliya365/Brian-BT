({
            ...
            if (state === "SUCCESS") { 
                ...
                if(response.getReturnValue() == 'SUCCESS'){
                    ...
                    toastEvent.setParams({
                        title : 'Success',
                        message: 'TakeOff Imported Successfully',
                        duration:' 5000',
                        key: 'info_alt',
                        type: 'success',
                        mode: 'dismissible'
                    ...
                    urlEvent.setParams({
                        "url": '/lightning/o/buildertek__Project_Takeoff__c/list?filterName=Recent'
                    });
                    urlEvent.fire();
    ...
    convertArrayOfObjectsToCSV : function(component,objectRecords){
        ...
        keys = ['Trade Type', 'Category', 'Product Type', 'Location', 'Quantity ', 'UOM '];
