({
    doInit: function (component, event, helper) {  
        ...
        action.setCallback(this, function (response) {
            ...
            for (var i = 0; i < listofchange.length; i++) {
                ...
                if(component.get("v.rfisettings") == true || component.get("v.rfisettings") == 'true'){
                    ...
                    if(listofchange[i].name != 'OwnerId' && listofchange[i].name != 'buildertek__Assigned_To__c'){
                        collist.push(listofchange[i]);
                    } 
                }else{
        ...
        var action = component.get("c.getRFQtoVendorRelatedRFIs");
        action.setParams({
            rfqToVenrdorId : component.get("v.recordId")
        })
        action.setCallback(this, function (response) {
            var fieldSetObj = response.getReturnValue();
        ...
        var action2 = component.get("c.getrfiresponeserecords1");
        action2.setParams({
            rfqToVenrdorId : component.get("v.recordId")
        })
        ...
        $A.enqueueAction(action2);
         //alert(component.get("v.rfq_Id"));
        var action = component.get("c.getrfqtovenrfirelatedfilesrecords");
        action.setParams({
    ...
    expandCollapseGroups : function (component, event, helper) {
       ...
       // alert('RFI Id          '+rfirecordid);
        ...
        var recId = component.get("v.rfq_Id");
