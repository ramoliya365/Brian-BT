({
		...
		$A.createComponents([
	                ...
	                if (status === "SUCCESS") {
	                    var modalPromise = component.find('overlayLib').showCustomModal({
	                        header: components[0],
	                        body: "Are you sure you want to delete this contract group?",
	                        footer: buttons,
    ...
    submit: function(component, event, helper) {
        ...
        fields["buildertek__Contract__c"] = component.get("v.contractId");
    ...
    onSuccess: function(component, event, helper) {
    	...
    	if(lines.length > 0) {
	        ...
	        for (var i = 0; i < lines.length; i++) {
	            ...
	            newQi.buildertek__Contract_Line_Group__c = null;
	            newQi.buildertek__Contract__c = component.get("v.contractId");
