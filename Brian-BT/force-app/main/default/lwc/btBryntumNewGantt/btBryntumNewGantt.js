            ...
            taskRenderer({ taskRecord, renderData }) {
                ...
                var eveLitener = function(e){
                    ...
                    if(!e.currentTarget.classList.contains('pastDueDatesText')){
                        ...
                        console.log('tomoute',ele.classList)
                       // ele.classList.add('pastDueDatesText')
                        //ele.classList.add('b-hover')
                        setTimeout(() =>  {
                        ...
                        //e.currentTarget.removeEventListener("mouseover",eveLitener)
                    }
                }
                if(taskRecord._data.endDate){
                    ...
                    if(eDate.getTime() < dat.getTime() && taskRecord.percentDone < 100) {
                        // if (taskRecord.endDate.getTime() < Date.now() && taskRecord.percentDone < 100) {
                            ...
                            //renderData.row.elements.locked.querySelectorAll('[data-column="name"]')[0].click();
                             if(!renderData.row.elements.locked.classList.contains('pastDueDatesText')){
                                ...
                                renderData.row.elements.locked.addEventListener('mouseover',eveLitener)
                                renderData.row.elements.locked.addEventListener('mouseleave',eveLitener)
                                renderData.row.elements.normal.addEventListener('mouseover',eveLitener)
                                renderData.row.elements.normal.addEventListener('mouseleave',eveLitener)
                        ...
                        if(renderData.taskRecord.cls.contains('pastDueDatesText')){
                            ...
                            renderData.row.elements.locked.removeEventListener('mouseover',eveLitener)
                            renderData.row.elements.locked.removeEventListener('mouseleave',eveLitener)
                            renderData.row.elements.normal.removeEventListener('mouseover',eveLitener)
                            renderData.row.elements.normal.removeEventListener('mouseleave',eveLitener) 
