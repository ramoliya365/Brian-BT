({
	getrfirecords : function(component, event, helper) {
        var rfiCMPId= component.get("v.recordId");
        var rfqCMPId= component.get("v.rfqId");
       // alert('rfiCMPId   helper       '+rfiCMPId);
         // alert('rfqCMPId   helper       '+rfqCMPId);
     ...
     */
      uploadHelper: function(component, event, newresponserecid, helper) {
        ...
        //var fileInput = component.get("v.selectedFiles");
        ...
        //this.fileInputLenght = fileInput.length;
          //alert('fileInputLenght---'+this.fileInputLenght);
        ...
        for (var i = 0; i < fileInput.length; i++) { 
            ...
            if(filenameexists){
                ...
                var self = this;
                // check the selected file size, if select file size > MAX_FILE_SIZE,
                ...
                self.uploadFileRFI(component, file,  newresponserecid, helper); 
            }
     ...
     * @param: File Data
     */
    uploadFileRFI:function(component, file,  newresponserecid, helper) {
        var self = this;
    ...
    save : function(component,newresponserecid) {
        ...
        if(fileInput!=null){
            ...
            fr.onload = function() {
                ...
                self.uploaddd(component, file, fileContents,newresponserecid);
            };
    ...
    uploaddd: function(component, file, fileContents,newresponserecid) {
        var fromPos = 0;
        var toPos = Math.min(fileContents.length, fromPos + this.CHUNK_SIZE);
		
       	// start with the initial chunk
        this.uploadChunkddd(component, file, fileContents, fromPos, toPos, '',newresponserecid);   
    },
     
    uploadChunkddd : function(component, file, fileContents, fromPos, toPos, attachId,newresponserecid) {
        var action = component.get("c.saveTheChunk"); 
        ...
        action.setCallback(this, function(a) {
            ...
            if (fromPos < toPos) {
            	self.uploadChunkddd(component, file, fileContents, fromPos, toPos, attachId,newresponserecid);  
            }else{
                this.showMessage('RFI Response created successfully',true);               
                component.set("v.IsSpinner",false);
