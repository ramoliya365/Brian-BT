...
trigger BillOfMaterialTrigger on buildertek__Project_Selection_Sheet_Takeoff__c (before insert,before update, before delete, 
                                   after insert, after update, after delete,after undelete) {

    BillOfMaterialTriggerHandler handler = new BillOfMaterialTriggerHandler(Trigger.isExecuting, Trigger.size);
