...
import search from '@salesforce/apex/SearchCompany.searchAccount';
const DELAY = 300;
export default class SearchCompanyLWC extends LightningElement {

    @api valueId;
    @api valueName;
    @api objName = 'Account';
    @api iconName = 'standard:account';
    @api labelName='Select Company';
    @api readOnly = false;
    @api currentRecordId;
    @api placeholder = 'Search for company';
    @api createRecord;
    @api fields = ['Name'];
