                          ...
                          //  alert(result);
                            if(result == "Vendor Submitted"){
                                ...
                                toastEvent.setParams({
                                    title : '',
                                    message: 'This Change Order Is Under Review.',
                                    duration:' 5000',
                                    key: 'info_alt',
                                    type: 'error',
                                    mode: 'dismissible'
                                ...
                                toastEvent.setParams({
                                    title : '',
                                    message: 'This Change Order Is Approved by Company, You cannot resubmit this Change Order.',
                                    duration:' 5000',
                                    key: 'info_alt',
                                    type: 'error',
                                    mode: 'dismissible'
                            ...
                            else if(result == "Company Rejected" || result == "Pending" ){
                                 component.set("v.IsActive", true)
                            }else {
                                var toastEvent = $A.get("e.force:showToast");
                                toastEvent.setParams({
                                    title : '',
                                    message: 'You can Submit the Change Order only when the Status is set to Pending or Company Rejected.',
                                    duration:' 5000',
                                    key: 'info_alt',
                                    type: 'error',
                                    mode: 'dismissible'
         ...
         //   alert(response.getState())
            ...
            //    alert(result);
                if(result == 'success'){
                    ...
                    toastEvent.setParams({
                        title : 'Success',
                        message: 'Change Order Submitted To Owner Successfully',
                        duration:' 5000',
                        key: 'info_alt',
                        type: 'Success',
                        mode: 'dismissible'
