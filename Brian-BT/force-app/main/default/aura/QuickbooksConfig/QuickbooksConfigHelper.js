({
    ...
    authorize: function(component,event,helper){
		var action = component.get("c.authorizeQuickBook");
        var obj = component.get("v.qbConfigs");
        action.setParams({ 
            "client_id": obj.buildertek__Client_Id__c,
            "client_secret": obj.buildertek__Client_Secret__c,
            "scope": obj.buildertek__Scope__c,
                         });
        action.setCallback(this, function(response){
