({
    ...
    sendEmail : function(component, event, helper) {
        ...
        //alert(rfiRec);
        var action = component.get("c.sendProposalforVendor1");
            action.setParams({
                recordId: rfiRec,
                rfqtovendorId:component.get("v.recordId"),
    ...
    SendEmailstoQueue : function(component,createdRecordId) {
        var action = component.get("c.sentEmailtousers");
        action.setParams({
