({
	...
	getFields: function (component, event, helper) {
		...
		action.setParams({
			objectName: 'buildertek__Time_Cards__c',
			fieldSetName: 'buildertek__Time_Card_FieldSet'
		});
		action.setCallback(this, function (response) {
			if (response.getState() == 'SUCCESS' && response.getReturnValue()) {
                ...
                for (var i = 0; i < listofchange.length; i++) {
                    if(listofchange[i].name != 'buildertek__Start_Location__Latitude__s'
                       && listofchange[i].name != 'buildertek__Start_Location__Longitude__s'){
        ...
        setTimeout(function () {
           ...
           // component.set("v.ismessage",false);
            ...
            toastEvent.setParams({
                ...
                messageTemplateData: [{
                    url: baseURL + '/lightning/r/buildertek__Time_Cards__c/' + escape(component.get("v.timecardRecordId")) + '/view',
